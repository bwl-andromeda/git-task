# Домашнее задание «Работа с удаленным репозиторием через GitHub»

Любые вопросы по решению задач задавайте преподавателю.
_______
...
1. Создайте папку на рабочем столе. Откройте для неё терминал.
...
1. Найдите на рабочем столе папку которую создали. Откройте для неё терминал.
...
1. Склонируйте репозиторий по [ссылке](https://github.com/bwl-andromeda/git-homework.git) на рабочий стол. Форкать репозиторий перед клонированием не нужно! 
